    ...
    if(!empty($_POST['username']) && !empty($_POST['password']))
    {
       ...
       $username = $_POST['username'];  
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            {
                 $msg ="Password Matched - Login Successfully done.";
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="contact__form">
                        <form name="loginform" method="POST" action="login.php">
                            ...
                            <button type="submit" name="btn_login" class="site-btn">Login</button>

                        </form>
                        <br><a href="registration.php"><button type="submit" class="site-btn">Click Here To Register</button></a>
                    </div>
                </div>
            </div>
        </div>
